...
public class CollectionsDTOmodify {
    String name;
    String color;
    String size;
    ...
    public CollectionsDTOmodify(String name, String color, String size, double priceWithIncludedTaxes, Integer categoryId, Integer discountId) {
        this.name = name;
        this.color = color;
        this.size = size;
